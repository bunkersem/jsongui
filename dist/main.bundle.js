...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_generate_schema__ = __webpack_require__("./node_modules/generate-schema/src/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_generate_schema___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_generate_schema__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WidgetComponent = (function () {
    function WidgetComponent(jsd, ucr) {
        this.jsd = jsd;
        this.ucr = ucr;
        this.title = "App works !";
    ...
    WidgetComponent.prototype.schemaFromJsonContent = function () {
        var s = __WEBPACK_IMPORTED_MODULE_3_generate_schema__["json"]('Root', this.jsd.json);
    ...
    WidgetComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_app_providers_jsondata_service__["a" /* JSONDataService */], __WEBPACK_IMPORTED_MODULE_2_app_providers_userconfig_userconfig_service__["a" /* UserConfigService */]])
    ], WidgetComponent);
